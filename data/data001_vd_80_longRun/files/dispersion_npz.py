...
if raw_analytic:
    ...
    ep = wla/wp    # Electron Langmuir Wave
...
plt.savefig(pjoin(path,'dispersion_npz.png'),dpi=dpi)
...
plt.savefig(pjoin(path,'EF_1499.png'),dpi=dpi)

"""
plt.figure(3)
plt.pcolor(K, Omega, F.imag, cmap='rainbow',shading='auto',vmin=-3.0,vmax=2.0)
plt.xlim([0, 1.0])
plt.ylim([0, 3.0])
"""
plt.show()
