...
w_pe*t = NUM_TS*DT
"""
ndeb = ndeb.reshape(DATA_TS,(NC+1))
mat = beta*np.ones(ndeb.shape)
ndeb = ndeb - mat
print("The shape of ndeb is: ", ndeb.shape)
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
wpet_1 = 0 #1000
wpet_2 = 500
...
ndb = ndeb[int(y1):int(y2),:]
print("The shape of ndb is: ",ndb.shape)

#+++++++++++++++++++++++++ FFT of E-field data ++++++++++++++++++++++++++++++++
Fb = np.fft.fftn(ndb, norm = 'ortho')
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Define Omega and K
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#------------------------------------------------------------------------------
halflen = np.array(Fb.shape, dtype=int)//2
...
plt.pcolor(K, Omega, Zb, cmap='rainbow',shading='auto',vmin=-12, vmax=-4)
#plt.pcolor(K, Omega, Zb, cmap='rainbow',shading='auto',vmin=np.min(Zb), vmax=np.max(Zb))
#cbar = plt.colorbar()
...
plt.savefig(pjoin(path,'dispersion_beamdensity_FFT1_%d_%d.png'%(wpet_1,wpet_2)),dpi=dpi)
...
plt.pcolor(xx, yy, ndeb, cmap='rainbow', shading='auto')
cbar = plt.colorbar()
cbar.set_label('$\Delta n_{b}$')

ax.set_xlabel('$x$')
ax.set_ylabel('$\omega_{pe}t$')

plt.savefig(pjoin(path,'dispersion_Delta_beamdensity_%d_%d.png'%(wpet_1,wpet_2)),dpi=dpi)
"""
plt.show()
