...
w_pe*t = NUM_TS*DT
"""
ndeh = ndeh.reshape(int(DATA_TS),int(NC+1))
...
ax.set_xlim([0, 1.0])
ax.set_ylim([0, 3.0])
plt.savefig(pjoin(path_fig,'dispersion_hot_density_vd_%d.png'%(20)),dpi=dpi)
"""
...
#plt.savefig(pjoin(path_fig,'dispersion_Delta_density_%d_%d.png'%(wpet_1,wpet_2)),dpi=dpi)
"""
plt.show()
